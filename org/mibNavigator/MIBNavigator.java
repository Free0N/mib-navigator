...
import org.mibNavigator.libmib.mibtree.MibTreeBuilderXml;
...
{
    private final MIBNavigatorSettings settings;  //saves and loads application state
    private final MibBrowser browser;             //main graphical component
    private final int maxAddresses;               //stores the maximum number of addresses to save (currently not modifiable 
