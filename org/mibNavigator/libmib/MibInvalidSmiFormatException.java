...
package org.mibNavigator.libmib;

import java.io.File;

public class MibInvalidSmiFormatException extends MibInvalidFormatException
{

    /**
     *  Creates a new MibInvalidSmiFormatException containing the
     *  default message: "This file is not a valid MIB file."
     */
    public MibInvalidSmiFormatException() 
    {
        super();
    }
    
    /**
     * Creates a new MibInvalidSmiFormatException containing the File that
     ...
     */
    public MibInvalidSmiFormatException(String extraDetails, File newInvalidFile) 
    {
        super("The file \"" + newInvalidFile.getName() + "\" is not a valid SMI MIB file." + extraDetails, newInvalidFile);
    }
    
    /**
     * Creates a new MibInvalidSmiFormatException with the invalid File that caused the exception
     * and an error message containing the name of this File.
     * 
     * @param newInvalidFile the MIB file that caused the exception
     */
    public MibInvalidSmiFormatException(File newInvalidFile) 
    {
