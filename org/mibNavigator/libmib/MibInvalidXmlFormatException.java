...
public class MibInvalidXmlFormatException extends MibInvalidFormatException 
{
    
    /**
     *  Creates a new MibInvalidXmlFormatException containing the
     *  default message: "This file is not a valid MIB file."
     */
    public MibInvalidXmlFormatException() 
    {
        super();
    }
    
    /**
     * Creates a new MibInvalidXmlFormatException containing the File that
     ...
     */
    public MibInvalidXmlFormatException(String extraDetails, File newInvalidFile) 
    {
        super("The file \"" + newInvalidFile.getName() + "\" is not a valid XML MIB file." + extraDetails, newInvalidFile);
    }
    
    /**
     * Creates a new MibInvalidXmlFormatException with the invalid File that caused the exception
     * and an error message containing the name of this File.
     * 
     * @param newInvalidFile the MIB file that caused the exception
     */
    public MibInvalidXmlFormatException(File newInvalidFile) 
    {
